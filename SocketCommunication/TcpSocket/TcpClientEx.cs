...
namespace SocketCommunication.TcpSocket
{
    public class TcpClientEx
    {
        ...
        public IClientCommand DispatcherAll()
        {
            TcpClientDispatcher clientdispatcher = new TcpClientDispatcher();
            clientdispatcher.RunAll(_fullrecvdata.ToList<byte>());
            return clientdispatcher._ClientCommand;
        }
